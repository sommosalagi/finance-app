...
function Nav() {
  const textLinkClasses =
    "active:tex-gray-400 text-gray-500 hover:text-gray-900 active:text-gray-400";
        ...
        <>
          <div className="flex h-[15vh] max-w-7xl items-center justify-between px-8 lg:px-12 xl:m-auto">
            ...
            <ButtonLink
              ...
              className="active: hidden rounded-xl bg-gray-800 px-5 py-3 text-white hover:bg-gray-900 active:bg-gray-600 sm:flex"
              target="_blank"
            />
